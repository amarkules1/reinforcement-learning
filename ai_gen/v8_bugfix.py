...
discount_factor = 0.9
q_table_file = "q_table.weights.h5" # Changed to .h5 extension for Keras weights file
...
def get_reward(current_state, action):
    ...
    reward +=  (1 / (food_distance + 1)) * 0.01  # Food proximity bonus, added small epsilon to avoid division by zero
    ...
    if head.distance(food) < 15:
        reward += 1 + (1 / (food_distance + 1)) * 0.01 # Big positive reward for food + food proximity bonus
